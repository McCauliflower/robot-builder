...
const parts = {
  heads: [
    ...
    },
    {
      ...
      title: 'Friendly Bot',
      src: getImage('head-friendly.png'),
      cost: 945.0,
      type: 'heads',
      onSale: true
    },
    {
      ...
      title: 'Shredder',
      src: getImage('head-shredder.png'),
      type: 'heads',
      cost: 1275.5
    },
    {
      ...
      title: 'Small Cyclops',
      src: getImage('head-single-eye.png'),
      type: 'heads',
      cost: 750.0
    },
    {
      ...
      src: getImage('head-surveillance.png'),
      type: 'heads',
      cost: 1255.5
    }
  ],
  arms: [
    {
      ...
      title: 'Articulated',
      src: getImage('arm-articulated-claw.png'),
      type: 'arms',
      cost: 275
    },
    {
      ...
      title: 'Two Clawed',
      src: getImage('arm-dual-claw.png'),
      type: 'arms',
      cost: 285
    },
    {
    ...
    },
    {
      ...
      title: 'Propeller',
      src: getImage('arm-propeller.png'),
      type: 'arms',
      cost: 230,
      onSale: true
    },
    {
      ...
      title: 'Stubby Claw',
      src: getImage('arm-stubby-claw.png'),
      type: 'arms',
      cost: 125
    }
  ],
  torsos: [
    {
      ...
      src: getImage('torso-flexible-gauged.png'),
      type: 'torsos',
      cost: 1575
    },
    {
  ...
  bases: [
    {
      ...
      src: getImage('base-double-wheel.png'),
      type: 'bases',
      cost: 895,
    },
    {
    ...
    },
    {
      ...
      src: getImage('base-single-wheel.png'),
      type: 'bases',
      cost: 1190.5,
    },
    {
    ...
    },
    {
      ...
      src: getImage('base-triple-wheel.png'),
      type: 'bases',
      cost: 700.5,
    }
  ]
